...
export async function seedProperties(propOwnerId: string) {
  console.log("🏨 Creating properties with room types...");
  ...
  for (const propertyData of properties) {
    ...
    if (roomTypes && roomTypes.length > 0) {
      ...
      console.log(`✅ Created ${property.name} with ${roomTypes.length} room types`);
    } else {
      console.log(`✅ Created ${property.name} (single-unit property)`);
    }
  }
