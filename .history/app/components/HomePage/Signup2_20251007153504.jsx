...
const Signup2 = ({
  ...
  return (
    <section className="bg-muted min-h-screen flex flex-col lg:flex-row">
      {/* Left Side */}
      <div className="flex flex-col flex-1 bg-background border-r border-gray-200 relative z-10">
        {/* Logo */}
        <div className="p-6 md:p-10 flex justify-center lg:justify-start">
        ...
        {/* Content */}
        <div className="flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24 flex-1">
          <div className="flex flex-col items-center gap-8 w-full max-w-md xl:max-w-lg">
            {/* Heading */}
            <h1 className="text-3xl sm:text-4xl xl:text-5xl 2xl:text-6xl font-semibold text-gray-900 text-center leading-tight tracking-tight">
              Welcome to <br />
              <span className="text-[#004F2D]">Findo</span>
              <span className="text-red-700">Trip</span>
            </h1>
            <p className="text-sm sm:text-base xl:text-lg text-center text-gray-600 max-w-sm xl:max-w-md">
      ...
      {/* Right Side */}
      <div className="hidden lg:flex flex-1 bg-[#004F2D] items-center justify-center relative overflow-hidden">
        ...
        />
        <h2 className="relative z-10 text-white text-4xl xl:text-6xl font-semibold drop-shadow-lg">
