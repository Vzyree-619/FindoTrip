      ...
      <div className="flex flex-col h-full w-full lg:w-1/2 bg-background border-r border-gray-200">
        ...
        <div className="flex flex-col flex-1 items-center justify-center ">
          <div className="flex flex-col items-center gap-6 w-full max-w-md">
            {/* Heading */}
            <h1 className="text-3xl font-extrabold tracking-tight text-center text-gray-900  w-[229px] h-[104.06px] top-[45px] left-[86px] 
            sm:w-[200px] sm:h-[90px] sm:top-[30px] sm:left-[40px]
            md:w-[229px] md:h-[104.06px] md:top-[45px] md:left-[86px]
            opacity-100">
              Welcome to <br />
