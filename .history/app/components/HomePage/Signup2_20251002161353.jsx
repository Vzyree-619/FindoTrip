...
const Signup2 = ({
  ...
  return (
    <section className="bg-muted h-screen flex">
      <div className="flex h-full items-center justify-center w-full shadow-md">
        <div className="flex flex-col items-center gap-6 lg:justify-start">
          ...
          <div className="min-w-sm border-muted bg-background flex w-full max-w-sm flex-col items-center gap-y-4 rounded-md border px-6 py-8 ">
