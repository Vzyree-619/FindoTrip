      ...
      <div className="flex flex-col h-full w-full lg:w-1/2 bg-background border-r border-gray-200">
        ...
        <div className="flex flex-col  items-center justify-center px-2 ">
          <div className="flex flex-col items-center gap-6 w-full max-w-md">
            {/* Heading */}
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-900  text-center">
              Welcome to <br />
            ...
            <div className="flex w-full border border-gray-300 rounded-md overflow-hidden h-12">
              <button
                ...
                className={`${! signup && "bg-[#E6F0EB]"} w-1/2 py-2 flex items-center justify-center text-gray-900 cursor-pointer hover:bg-gray-100`}
              >
                Sign In
              </button>
              <button
                onClick={() => setSignup(true)}
                className={`${signup && "bg-[#E6F0EB]"} w-1/2 py-2 flex items-center justify-center  text-gray-900 font-medium`}
              >
                Sign Up
              </button>
            </div>
