      ...
      <div className="flex flex-col h-full w-full lg:w-1/2 bg-background border-r border-gray-200">
        ...
        <div className="flex flex-col flex-1 items-center justify-center ">
          <div className="flex flex-col items-center gap-6 w-full max-w-md">
            {/* Heading */}
            <h1 className="text-3xl font-bold text-gray-900 font-inter text-[40px] leading-[100%] tracking-normal text-center">
              Welcome to <br />
            ...
            {/* Form */}
            <form className="flex flex-col gap-4 w-full font-sans">
              <div className="flex flex-col gap-2">
                <Label htmlFor="name" className="text-gray-700 font-inter font-medium text-sm leading-5 tracking-normal">
                  Your Full Name
                </Label>
                <Input
                  id="name"
...
<h1 className="font-sans">hello</h1>
              <div className="flex flex-col gap-2">
                <Label htmlFor="email" className="text-gray-700 font-medium font-blauer">
                  Email Address
                </Label>
                <Input
                  id="email"
