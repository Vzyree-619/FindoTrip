...
const Signup2 = ({
  ...
  return (
   <section className="bg-muted min-h-screen flex overflow-y-auto lg:overflow-hidden">
      ...
      <div className="flex flex-col h-full w-full lg:w-1/2 bg-background border-r border-gray-200">
        ...
        <div className="flex flex-col items-center justify-center px-4 pb-4">
          <div className="flex flex-col items-center gap-6 w-full max-w-md">
            {/* Heading */}
            <h1 className="text-5xl font-semibold text-gray-900 font-inter text-center">
              Welcome to <br />
