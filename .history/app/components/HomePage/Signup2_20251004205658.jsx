          ...
          <div className="flex flex-col items-center gap-6 w-full max-w-md">
            ...
            <form className="flex flex-col gap-4 w-full text-sm font-inter">
              ...
              <Button
                ...
                className="w-full h-12 rounded bg-[#004F2D] hover:bg-[#003621] text-white font-semibold"
              >
                {buttonText}
              </Button>
            </form>
            ...
            <div className="flex flex-col gap-2 w-full">
              <Button
                variant="outline"
                className="w-full h-10 rounded border-gray-300 flex items-center justify-center gap-2"
              >
                <img
