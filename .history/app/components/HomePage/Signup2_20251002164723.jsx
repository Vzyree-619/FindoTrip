    ...
    <section className="bg-muted h-screen flex">
      <div className="flex h-full items-center justify-center w-full shadow-md bg-background border-muted border">
        <div className="flex flex-col items-center gap-6 lg:justify-start">
          ...
          <div
            className="flex h-20 rounded-md w-full border items-center bg-transparent px-3 py-1 shadow-sm md:text-sm text-sm font-medium leading-none justify-center"
          >
