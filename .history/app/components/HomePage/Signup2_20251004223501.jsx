        ...
        <div className="flex flex-col  items-center justify-center px-2 ">
          <div className="flex flex-col items-center gap-6 w-full max-w-md">
            ...
            <div className="flex w-full border border-gray-300 rounded-md overflow-hidden h-12">
              <button onClick={()=>setSignup(false)} className="w-1/2 py-2 flex items-center justify-center text-gray-700 cursor-pointer hover:bg-gray-100">
                Sign In
              </button>
              <button onClick={()=>setSignup(true)} className="w-1/2 py-2 flex items-center justify-center bg-[#E6F0EB] text-gray-900 font-medium">
                Sign Up
              </button>
            </div>
