...
const InputField = ({ id, label, type, placeholder, autoComplete = "off" }) => (
  <div className="flex flex-col gap-2 w-full">
    <Label htmlFor={id} className="text-gray-700 font-medium leading-6">
      {label}
    </Label>
    <Input
      id={id}
...
const Signup2 = ({
  ...
  return (
    <section className="bg-muted h-full lg:flex ">
      {/* Left Side */}
      <div className="flex flex-col w-full lg:w-1/2 bg-background border-r border-gray-200">
        {/* Logo */}
        ...
        <div className="flex flex-col items-center justify-center px-2">
          <div className="flex flex-col items-center gap-4 w-full max-w-md">
            {/* Heading */}
            <h1 className="text-4xl  font-semibold text-gray-900 font-inter text-center">
              Welcome to <br />
            ...
            <form
              ...
              className="flex flex-col gap-4 h-fit w-full"
            >
              {formType === "signup" ? (
                <>
                  <InputField
