          ...
          <div className="flex flex-col items-center gap-6 w-full max-w-md">
            ...
            <div className="flex w-full border border-gray-300 rounded-md overflow-hidden h-12">
              <button
                ...
                className="w-1/2 py-2 flex items-center justify-center text-gray-900 cursor-pointer hover:bg-gray-100"
              >
                Sign In
              </button>
              <button
                onClick={() => setSignup(true)}
                className="w-1/2 py-2 flex items-center justify-center bg-[#E6F0EB] text-gray-900 font-medium"
              >
                Sign Up
              </button>
            </div>
            ...
            {signup ? (
              ...
              <form className="flex flex-col gap-4 w-full text-sm font-blauer">
                <div className="flex flex-col gap-2 w-full">
                  <Label
                    htmlFor="email"
                    className="text-gray-700 font-medium leading-5 font-inter"
                  >
                    Email Address
                  </Label>
                  <Input
                ...
                {/* Terms */}
                <div className="flex gap-2 text-xs text-gray-600 justify-between items-center">
                  <div>
                    <input type="checkbox" id="terms" className="mt-1" />
