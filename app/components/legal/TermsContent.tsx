...
export default function TermsContent() {
  return (
    <div className="prose prose-lg max-w-none">
      ...
      <p>
        By accessing and using FindoTrip ("the Service"), you accept and agree to be bound by the terms and
        provision of this agreement. If you do not agree to abide by the above, please do not use this service.
      </p>

      <h2>2. Description of Service</h2>
      <p>
        FindoTrip is a travel platform that connects travelers with accommodation providers, car rental services,
        and tour guides. We facilitate bookings and provide a marketplace for travel-related services.
      </p>
      ...
      <p>When you make a booking through FindoTrip:</p>
      <ul>
      ...
      <p>Service providers (accommodation owners, car providers, tour guides) agree to:</p>
      <ul>
      ...
      <p>
        The Service and its original content, features, and functionality are owned by FindoTrip and are protected by
      ...
      <p>
        FindoTrip acts as an intermediary between users and service providers. We do not own, operate, or control the
        accommodations, vehicles, or tour services listed on our platform. We are not responsible for:
      </p>
      <ul>
      ...
      <p>
        To the fullest extent permitted by law, FindoTrip shall not be liable for any indirect, incidental, special,
        consequential, or punitive damages, or any loss of profits or revenues.
      </p>

      <h2>12. Indemnification</h2>
      <p>
        You agree to defend, indemnify, and hold harmless FindoTrip from and against any claims, damages, costs, and
