...
export function ConversationList({
  ...
  return (
    <div className={clsx("h-full flex flex-col min-h-0", className)}>
      <div className="p-3 border-b bg-white dark:bg-gray-800 dark:border-gray-700 flex-shrink-0">
        <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1">
          ...
          <input
            ...
            className="flex-1 bg-transparent outline-none text-sm py-1 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
          />
        </div>
      </div>
            ...
            .map((conv) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left p-3 hover:bg-gray-50 dark:hover:bg-gray-700 focus:bg-gray-50 dark:focus:bg-gray-700"
                >
                  <div className="flex items-center gap-3">
                    <img src={p?.avatar || "/avatar.png"} alt="avatar" className="w-10 h-10 rounded-full object-cover" />
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <div className="truncate font-medium text-gray-900 dark:text-gray-100">{p?.name || "Unknown"}</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap">{formatTimeAgo(conv.updatedAt || new Date())}</div>
                      </div>
