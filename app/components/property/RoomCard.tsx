...
export default function RoomCard({
  ...
  return (
    <div className={`bg-white rounded-xl border-2 ${isSelected ? 'border-[#01502E] shadow-lg' : 'border-gray-200'} overflow-hidden transition-all duration-300 hover:shadow-md min-h-[420px]`}>
      <div className="grid grid-cols-1 md:grid-cols-[280px_minmax(0,1fr)_260px] gap-4 md:gap-6 p-5 md:p-6">
        {/* Room Image */}
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Room Features (moved above price card) */}
          <div>
          ...
          {/* Compact price & action inside the card (mobile/tablet) */}
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 space-y-2 shadow-sm md:hidden">
            ...
            <div className="flex flex-col gap-2">
              {onBook && (
                <button
                  ...
                  className="w-full max-w-xs mx-auto py-2.5 bg-[#01502E] text-white rounded-lg font-semibold hover:bg-[#013d23] disabled:bg-gray-300 disabled:cursor-not-allowed transition"
                >
        ...
        {/* Price & Actions - right column (desktop) */}
        <div className="hidden md:flex flex-col gap-3 md:sticky md:top-4 h-fit">
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 space-y-2 shadow-sm">
            <div className="text-xs text-gray-600">Starting from</div>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-bold text-[#01502E]">
                {room.currency} {room.basePrice.toLocaleString()}
