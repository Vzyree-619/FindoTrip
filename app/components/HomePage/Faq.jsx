...
const useIsomorphicLayoutEffect =
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-start gap-6 w-[97vw] max-w-5xl mx-auto p-4 md:p-8 overflow-y-hidden">
      {/* FAQs Section */}
        ...
        {faqData.map((item, index) => (
          <div key={index} className="border border-green-700 rounded-md">
            <button
              ...
              className="flex justify-between items-center w-full px-4 py-2 text-left text-green-800 font-medium"
            >
              {item.question}
