export default function Room() {
  return (
    <>
      <div className=" p-4">
        <img
          className="w-[100vw] rounded h-[50vh] object-cover object-[50%_35%]"
          src="homePage.png"
          alt="homeImg"
        />
      </div>
      <div lang="en-GB" className="">
        ...
        <form method="post" action="/input" className="w-full">
          ...
          <div className="hidden md:block">
            ...
            <label
              className="text-black ml-[12vw] text-[13px] underline"
              htmlFor="checkIn"
            >
              CheckIn
            </label>
            ...
            <label
              className="text-black text-[13px] underline"
              htmlFor="checkOut"
            >
              CheckOut
            </label>
            ...
            <button
              type="submit"
              className="w-[10vw] p-2 text-white bg-[#01502E] rounded  absolute top-[84.6vh] right-[21.5vw]"
            >
              Search
            </button>
          </div>
          ...
          <div className="md:hidden flex flex-col gap-2 p-2">
            ...
            <div className="flex gap-2">
              <div className="flex-1">
                <label className="text-black text-[10px] " htmlFor="checkIn">
                  Check In
                </label>
                <input
                  name="checkIn"
              ...
              <div className="flex-1">
                <label className="text-black text-[10px] " htmlFor="checkOut">
                  Check Out
                </label>
                <input
                  type="date"
            ...
            <button
              type="submit"
              className="w-full  p-3 text-white bg-[#01502E] rounded"
            >
              Search
            </button>
          </div>
