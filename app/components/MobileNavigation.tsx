...
export default function MobileNavigation({ user }: MobileNavigationProps) {
  ...
  const navigationItems = [
    ...
    { to: "/car_rentals", icon: Car, label: "Car Rentals" },
    { to: "/tour_guides", icon: MapPin, label: "Tour Guides" },
  ];
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <nav
        className={`fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white shadow-xl z-40 transform transition-transform duration-300 ease-in-out lg:hidden ${
