        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="text-center">
            <p className="text-2xl font-bold text-green-600">
              PKR {type === 'property' ? item.basePrice :
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Review and approve provider registrations</p>
        </div>
          ...
          {pendingProperties.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {pendingProperties.map((property) => (
                <ApprovalCard key={property.id} item={property} type="property" />
              ))}
            </div>
          )}
        </div>
          ...
          {pendingVehicles.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {pendingVehicles.map((vehicle) => (
                <ApprovalCard key={vehicle.id} item={vehicle} type="vehicle" />
              ))}
            </div>
          )}
        </div>
          ...
          {pendingTours.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {pendingTours.map((tour) => (
                <ApprovalCard key={tour.id} item={tour} type="tour" />
              ))}
            </div>
          )}
        </div>
