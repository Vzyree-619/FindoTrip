...
const tours = [
  {
    ...
    description:
      "Experience the stunning landscapes of Skardu Valley with guided tours to lakes, deserts, and mountain peaks.",
  ...
  },
  {
    ...
    description:
      "Join our trekking expedition through Baltoro Glacier, one of the most breathtaking trails in the Karakoram range.",
    reviews: "987 reviews",
    score: "9.5",
    image:
      "https://th.bing.com/th/id/OIP.vRGrvXRJcG7FWYev0ay2-gHaFj?rs=1&pid=ImgDetMain",
    gallery: [
      "https://th.bing.com/th/id/OIP.vRGrvXRJcG7FWYev0ay2-gHaFj?rs=1&pid=ImgDetMain",
      "/deosai.jpg",
      "/khaplu.jpg",
  ...
  },
  {
    ...
    description:
      "Discover ancient forts, beautiful mosques, and the unique culture of Shigar Valley with our guided cultural tours.",
    reviews: "742 reviews",
    score: "9.0",
    image:
      "https://th.bing.com/th/id/OIP.8mA5erSB4UTHqFoZRvv-GQHaEH?rs=1&pid=ImgDetMain",
    gallery: [
      "https://th.bing.com/th/id/OIP.8mA5erSB4UTHqFoZRvv-GQHaEH?rs=1&pid=ImgDetMain",
      "/shiger.jpg",
      "/shigerFort.jpg",
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <p className="mb-2">
              Price: {tour.price}{" "}
              <span className="text-red-500 line-through">{tour.discount}</span>
            </p>
