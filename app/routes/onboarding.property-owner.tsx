...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    //   data: {
    //     type: "PROFILE_UPDATE",
    //     title: "Property Owner Profile Approval",
    //     description: `New property owner registration for ${businessName}`,
    //     requesterId: userId,
    ...
    return redirect("/dashboard/provider?welcome=true&pending=true");
  } catch (error) {
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="businessLicenseDoc" className="block text-sm font-medium text-gray-700 mb-2">
                        Business License Document (PDF)
                      </label>
                      <input
                        type="file"
                        id="businessLicenseDoc"
                        name="businessLicenseDoc"
                    ...
                    <div>
                      <label htmlFor="taxIdDoc" className="block text-sm font-medium text-gray-700 mb-2">
                        Tax ID Document (PDF)
                      </label>
                      <input
                        type="file"
                    ...
                    <div>
                      <label htmlFor="bankStatementDoc" className="block text-sm font-medium text-gray-700 mb-2">
                        Bank Statement (PDF)
                      </label>
                      <input
                        type="file"
                        ...
                        accept=".pdf,.jpg,.jpeg,.png"
                        className="block w-full text-sm text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100"
                      />
                    </div>
                  </div>
                </div>
