...
import { Settings, MessageCircle, Bell, Shield, Palette, Volume2, VolumeX, Eye, EyeOff } from "lucide-react";
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const privacySettings = user.privacySettings ? JSON.parse(user.privacySettings) : {
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    if (intent === "updateChatSettings") {
      ...
      return json({ success: true, message: "Chat settings updated successfully" });
    }
...
export default function ChatSettings() {
  const { user, chatSettings, privacySettings } = useLoaderData<typeof loader>();
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center space-x-3">
                      <input
                        ...
                        name="theme"
                        value="light"
                        defaultChecked={chatSettings.theme === 'light'}
                    ...
                    <label className="flex items-center space-x-3">
                      <input
                        ...
                        name="theme"
                        value="dark"
                        defaultChecked={chatSettings.theme === 'dark'}
                        onChange={(e) => handleThemeChange(e.target.value)}
                        className="text-[#01502E] focus:ring-[#01502E]"
                      />
                    ...
                    <label className="flex items-center space-x-3">
                      <input
                        ...
                        name="theme"
                        value="auto"
                        defaultChecked={chatSettings.theme === 'auto'}
                        onChange={(e) => handleThemeChange(e.target.value)}
                        className="text-[#01502E] focus:ring-[#01502E]"
                      />
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Show when you're typing a message</p>
                  </div>
                </label>
                ...
                <label className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Allow others to send you files</p>
                  </div>
                </label>
                ...
                <label className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <span className="font-medium">Messages from Service Providers</span>
                    <p className="text-sm text-gray-600">Allow service providers to message you</p>
                  </div>
                </label>
                ...
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    defaultChecked={privacySettings.allowMessagesFromCustomers}
                    className="rounded border-gray-300 text-[#01502E] focus:ring-[#01502E]"
                  />
                  <div>
                    <span className="font-medium">Messages from Customers</span>
                    <p className="text-sm text-gray-600">Allow customers to message you</p>
                  </div>
                </label>
              </div>
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Send automatic responses when you're not available</p>
                  </div>
                </label>
              </div>
