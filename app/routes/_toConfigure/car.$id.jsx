...
const cars = [
  {
    id: 1,
    title: "Honda BRV",
    description: "Comfortable and reliable with spacious seating.",
  ...
  },
  {
    id: 3,
    title: "Hiace Van",
    description: "Spacious van ideal for group travels.",
  ...
  },
  {
    id: 4,
    title: "Honda BRV",
    description: "Another view of the Honda BRV.",
    price: "PKR 15,000/day",
    image: "/car.jpg",
  },
];
  ...
  const handleSend = () => {
    if (chatMsg.trim()) {
      ...
      setTimeout(() => {
        setChatHistory((h) => [
          ...h,
          { from: "owner", text: "Thanks for your message! (Dummy)" },
        ]);
      }, 1000);
    }
  };
          ...
          <div>
            ...
            <div className="mb-6 flex items-center gap-4 bg-gray-100 p-4 rounded">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Rating: {owner.rating} ⭐ ({owner.reviews} reviews)
                </div>
                <div className="text-sm text-gray-600">
                  Phone: {owner.phone}
                </div>
                <button
                  className="mt-2 px-4 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 w-full md:w-auto"
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-5 space-y-1">
                {addOns.map((a, i) => (
                  <li key={i}>
                    {a.name} <span className="text-gray-500">({a.price})</span>
                  </li>
                ))}
              </ul>
            </div>
              ...
              {chatHistory.map((msg, i) => (
                ...
                >
                  <span
                    className={
                      msg.from === "user"
                        ? "bg-green-100 px-2 py-1 rounded inline-block my-1"
                        : "bg-blue-100 px-2 py-1 rounded inline-block my-1"
                    }
                  >
                    {msg.text}
                  </span>
