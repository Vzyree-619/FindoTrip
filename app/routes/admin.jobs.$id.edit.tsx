...
import { useLoaderData, useNavigate, Form, useActionData, useParams } from "@remix-run/react";
...
export default function EditJob() {
  const { admin, job } = useLoaderData<typeof loader>();
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select name="department" required defaultValue={job.department}>
                <SelectTrigger>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select name="type" required defaultValue={job.type}>
                <SelectTrigger>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              name="expiresAt"
              type="date"
              defaultValue={formatDate(job.expiresAt)}
            />
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                name="isPublished"
                value="true"
                defaultChecked={job.isPublished}
                className="rounded border-gray-300"
              />
