...
export async function loader({ request }: LoaderFunctionArgs) {
  try {
    console.log("Root loader: Starting user fetch");
    const user = await getUser(request);
    console.log("Root loader: User fetched successfully", user?.id);
    return json({ user });
  } catch (error) {
    console.error("Root loader error:", error);
    // Return null user instead of throwing to prevent app crash
